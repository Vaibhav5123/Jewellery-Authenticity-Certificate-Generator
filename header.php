...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo "Jwellery Authenticity Certificate Generator"; ?></title>
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <a href="index.php" class="logo d-flex align-items-center">
                    ...
                    <span class="d-none d-lg-block">JEWELLERY</span>
                </a>
                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                            <i class="bi bi-person-square"></i><span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $name ?></span>
